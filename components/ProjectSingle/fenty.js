...
const ProjectSingleFenty = ( props ) => {
    return(
                    ...
                    <div className="col-lg-8 offset-lg-2">
                        <div className="wpo-minimal-wrap">
                            <div className="wpo-minimal-img">
                                <img src='/images/project/3a.png' alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="wpo-p-details-section">
                            <p>This is an example of a promotional email that i created. This email is created with HTML and CSS. This email is fully responsive and was tested using limtmus. It displays correctly across all major email clients.  </p>
                            <div className="row">
...
export default ProjectSingleFenty;